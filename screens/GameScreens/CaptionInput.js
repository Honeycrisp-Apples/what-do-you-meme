...
export default class CaptionInput extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      show: 'flex',
      player:
        "new Player('../../assets/audio/Tick-DeepFrozenApps-397275646.mp3')",
    };
  ...
  async playSound() {
    ...
    await soundObject.loadAsync(
      require('../../assets/audio/Tick-DeepFrozenApps-397275646.mp3')
    );
    await soundObject.playAsync();
  }
  captionChange() {
      ...
      <SafeAreaView style={styles.panel}>
        ...
        >
          ...
          >
            ...
            <View
              style={{
                ...
                width: 300,
                height: 300,
                backgroundColor: 'rgba(249,166,2,0.5)',
                borderWidth: 3,
                borderColor: 'orange',
              }}
            >
          ...
          <FormButton
            ...
            colorValue={'white'}
            modeValue={'contained'}
            onPress={() => this.props.navigation.navigate('VotingScreen')}
          />
